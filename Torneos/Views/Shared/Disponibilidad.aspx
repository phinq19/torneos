<%@ Page Title="ACAF Disponibilidad" Language="C#" MasterPageFile="~/Views/Shared/MarcoLogeado.master"
...
<asp:Content ID="Content1" ContentPlaceHolderID="Contenido" runat="server">
    <script type='text/javascript'>
        ...
        function GuardarDiponibilidad() {
            ...
            var tiempoLunesT = $("#ChkLunesT").attr('checked') == true ? 2 : 0;
            var tiempoMartesT = $("#ChkMartesT").attr('checked') == true ? 2 : 0;
            var tiempoMiercolesT = $("#ChkMiercolesT").attr('checked') == true ? 2 : 0;
            var tiempoJuevesT = $("#ChkJuevesT").attr('checked') == true ? 2 : 0;
            var tiempoViernesT = $("#ChkViernesT").attr('checked') == true ? 2 : 0;
            var tiempoSabadoT = $("#ChkSabadoT").attr('checked') == true ? 2 : 0;
            var tiempoDomingoT = $("#ChkDomingoT").attr('checked') == true ? 2 : 0;

            var tiempoLunesN = $("#ChkLunesN").attr('checked') == true ? 3 : 0;
            var tiempoMartesN = $("#ChkMartesN").attr('checked') == true ? 3: 0;
            var tiempoMiercolesN = $("#ChkMiercolesN").attr('checked') == true ? 3 : 0;
            var tiempoJuevesN = $("#ChkJuevesN").attr('checked') == true ? 3 : 0;
            var tiempoViernesN = $("#ChkViernesN").attr('checked') == true ? 3 : 0;
            var tiempoSabadoN = $("#ChkSabadoN").attr('checked') == true ? 3 : 0;
            var tiempoDomingoN = $("#ChkDomingoN").attr('checked') == true ? 3 : 0;
