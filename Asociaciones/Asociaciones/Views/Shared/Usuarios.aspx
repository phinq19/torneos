<%@ Page Title="Asociación Usuarios" Language="C#" MasterPageFile="~/Views/Shared/MarcoLogeado.master" Inherits="System.Web.Mvc.ViewPage<dynamic>" %>
    ...
    <script type='text/javascript'>
        $(document).ready(function () {
            ...
            $("#gridUsuarios").jqGrid({
                ...
                colNames: ['id', 'Nombre', 'Cédula', 'Tipo', 'Correo', 'Teléfono', 'Activo', 'Observaciones'],
                colModel: [
